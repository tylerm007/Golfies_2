...
resourcename="golfies2"  # lower case, only
resourcegroup="golfies2_rg"
...
# git clone https://github.com/apilogicserver/golfies2.git
# cd golfies2
...
az group create --name golfies2_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group golfies2_rg --sku S1 --is-linux
az container create --resource-group golfies2_rg --name golfies2 --image apilogicserver/golfies2:latest --dns-name-label golfies2 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//golfies2.westus.azurecontainer.io:5656'
