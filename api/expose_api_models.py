...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.OrderDiscountLink, method_decorators= method_decorators)
    api.expose_object(database.models.OrderItem, method_decorators= method_decorators)
    api.expose_object(database.models.ProductCategoryLink, method_decorators= method_decorators)
    api.expose_object(database.models.ProductSupplierLink, method_decorators= method_decorators)
